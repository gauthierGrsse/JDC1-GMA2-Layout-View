...
function setupFixtInLayout(fixture, offset_x, offset_y)
    for x = 1, 25, 1 do
...
function start()
    ...
    if (gma.gui.confirm("Confirm", "Confirm JDCs instances group and layout create for Fixture " .. startID .. " to " ..
        ...
        for x = startID, endID, 1 do
            setupFixtInLayout(x, countFixture * 8, countFixtureY * 7);
            feedback("Setup fixture " .. x .. " in layout xml");
            countFixture = countFixture + 1
            if (countFixture >= 8) then
                countFixture = 0;
        ...
        -- Store xml variable in xml file
